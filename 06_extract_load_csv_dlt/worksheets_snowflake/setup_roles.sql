...
-- grant to users
GRANT ROLE movies_dlt_role TO USER extract_load;
GRANT ROLE movies_reader_role TO USER nasrwahi;
GRANT ROLE movies_dlt_role TO USER nasrwahi;
...
SHOW GRANTS TO USER extract_load;
